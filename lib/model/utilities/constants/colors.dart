...
const Color primary500 = Color.fromRGBO(0, 152, 76, 1);
const Color primary400 = Color.fromRGBO(77, 171, 124, 1);
const Color primary50 = Color.fromRGBO(245, 245, 245, 1);
const Color repaymentCard = Color.fromRGBO(180, 189, 184, 0.11);
const Color repaymentHeading = Color.fromRGBO(166, 166, 166, 1);
...
const Color darkGreen = Color.fromRGBO(20, 34, 27, 1);
...
const Color purple = Color.fromRGBO(96, 4, 104, 0.5);
const Color orange = Color.fromRGBO(245, 143, 48, 0.5);
const Color gold = Color.fromRGBO(210, 170, 29, 0.3);
const Color myRed = Color.fromRGBO(208, 35, 35, 0.3);
